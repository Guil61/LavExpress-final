...
public class AgendamentoController {
    ...
    /**
     * Obtém agendamentos de um lava jato específico
     * @param lavaJatoId ID do lava jato
     * @return Lista de agendamentos do lava jato
     */
    @GetMapping("/lavajato/{lavaJatoId}")
    public ResponseEntity<List<AgendamentoDto>> listarPorLavaJato(@PathVariable Long lavaJatoId) {
     ...
     */
    @PostMapping
    public ResponseEntity<AgendamentoDto> criar(@RequestBody AgendamentoDto agendamentoDto) {
        // Validações
    ...
    public ResponseEntity<AgendamentoDto> atualizarStatus(@PathVariable Long id, @RequestBody Map<String, String> statusData) {
    ...
    public ResponseEntity<Map<String, String>> excluir(@PathVariable Long id) {
        ...
        if ("EM_ANDAMENTO".equals(agendamento.getStatus())) {
            ...
            response.put("mensagem", "Agendamento cancelado");
        ...
        Map<String, String> response = new HashMap<>();
        response.put("mensagem", "Agendamento excluído com sucesso");
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<Map<String, Boolean>> verificarDisponibilidade(
            @RequestParam Long lavaJatoId,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime dataHora) {

        boolean horarioOcupado = agendamentoRepository.existsByLavaJatoIdAndDataHora(lavaJatoId, dataHora);

        Map<String, Boolean> response = new HashMap<>();
        response.put("disponivel", !horarioOcupado);
